	...
	<body>
		<div class="header">
			...
			<div class="container">
				<div class="row">
					<div class="col-md-12">
						<p>The UN is planning a program for food distribution to a remote area of central Asia
							...
							of food distribution on the community!</p>
					</div>
					<div class="row">
						<div class="col-md-3">
							<p> Anthropology is the study of culture as a complex system that requires study of many
								diverse component parts. Studying other cultures requires that one live with the
								</p>
						</div>
						<div class="row">
							<div class="col-md-3">
								<p>subject of their study. Holism describes a specific type of fieldwork that involves immersion in a
									culture, and taking on aspects of the community being studied to better</p>
							</div>
							<div class="row">
								<div class="col-md-3">
									<p>understand it. A fossil is any trace or impression of an organism that has been preserved in the earth's
										crust from past geologic time. Dead animal materials are most</p>
								</div>
								<div class="row">
									<div class="col-md-3">
										<p>likely to NOT to become fossilized. Physical anthropologists study human biology including growth patterns,
											diet, disease, skeletal anatomy, and demographics.</p>
									</div>
									<div class="row">
										<div class="col-md-6">
											<p>The ABO blood groups in humans are controlled by three alleles of a single gene.
												O is recessive, while A and B are codominant (an individual with both the A and B
												alleles will have the blood type</p>
										</div>
										<div class="row">
											<div class="col-md-6">
												<p> AB rather than A or B). If a woman who has type O blood gives birth to a
													child with type O blood could herhusband,who has type AB blood, be the father of
													this child?! The answer is NO!!!</p>
												<div class="footer">
											</div>
										</div>
